...
import lanyard from '../../../assets/textures/lanyard.png';
...
export default function Lanyard({ position = [0, 0, 30], gravity = [0, -40, 0], fov = 16, transparent = true }) {
