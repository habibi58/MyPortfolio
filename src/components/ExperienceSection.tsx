...
export const ExperienceSection = () => {
  ...
  const openLightbox = (imgSrc: string | null, emoji: string, title: string, desc: string) => {
    ...
    if (imgSrc) {
      ...
      img.onerror   = () => { preview.innerHTML = emoji || '📄'; preview.style.fontSize = '72px'; };
      img.src       = imgSrc;
  ...
  return (
    <section id="experience" className="relative py-24 overflow-hidden">
      ...
      <style>{`
        ...
        .exp-lb-box { box-sizing: border-box; }
        #exp-lb-img {
          min-height: 120px; max-height: 55vw; width: 100%;
        ...
        @media (max-width: 767px) {
          ...
          #exp-lb-img { min-height: 200px; max-height: 65vw; }
          #exp-lb-img img {
            max-width: 100% !important; max-height: 62vw !important;
            width: auto !important; height: auto !important;
            object-fit: contain !important;
          }
          #exp-lb-title { font-size: 14px !important; }
          #exp-lb-desc  { font-size: 12px !important; }
        }
      `}</style>
      ...
      >
        <div className="exp-lb-box" style={{
          background: '#08101e', border: '0.5px solid rgba(255,255,255,0.12)',
          borderRadius: '22px', padding: '20px',
          maxWidth: '620px', width: '92%', maxHeight: '90vh', overflowY: 'auto',
      ...
      <div className="relative max-w-6xl mx-auto px-3 sm:px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative">
          <div
            className="hidden md:block absolute left-1/2 -translate-x-1/2 w-px h-full pointer-events-none"
